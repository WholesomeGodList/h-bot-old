        ...
        try {
            ...
            if (results.isEmpty()) {
                ...
                if (nonrestrict) {
                    ...
                    bruh.setAuthor("Random Search Result", "https://nhentai.net/search/?q=" + URLEncoder.encode(query, StandardCharsets.UTF_8) + "&sort=popular&page=1", "https://i.redd.it/fkg9yip5yyl21.png");
